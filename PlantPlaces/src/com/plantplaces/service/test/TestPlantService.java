...
public class TestPlantService extends TestCase {
	...
	/**
	 * Verifica que el arreglo de plantas filtrado sea 2!
	 * */
	...
	/**
	 * Verifica que se pueda filtrar por texto "Red"
	 * */
	...
	/**
	 * Llena el servicio dummy con un arreglo dummy.
	 * */
	private void givenThatPlantServiceIsPopulatedWithPlantDAO() {
		plantService = new PlantService();
		
		//un objecto mock es el caparazón de un objeto que hará lo que queramos.
